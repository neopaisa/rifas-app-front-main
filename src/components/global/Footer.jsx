...
import logoBlanco from "../../assets/logo/logoM_white.png";
function Footer() {
  return (
    <footer className="bg-neutral-600 text-center text-white dark:bg-neutral-600 dark:text-white lg:text-left">
      <div className="flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
        ...
        <div className="flex justify-center"> 
          <a href="https://instagram.com/rifacasa_torovalle?igshid=NzZhOTFlYzFmZQ==" rel="noreferrer" className="mr-6 text-white dark:text-neutral-200" target="_blank">
            <svg
